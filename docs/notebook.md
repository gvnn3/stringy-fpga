...
- Entry bodies are kept in **chronological order** — EXPERIMENT 1 at
  the top, each new entry appended at the end (append-only; adopted
  11 Aug 2026). The ToC lists newest first.
- ToC entries are bullets of the form `[EXPERIMENT N: DD Mon YYYY
  HH:MM:SS Title]`, where N is a **stable chronological ID**: #1 is
  the oldest experiment, forever. A new entry takes the next number
  and is listed first; existing numbers never change (adopted
  11 Aug 2026 — numbers before that date drifted positionally).
...
- [EXPERIMENT 34: 11 Aug 2026 11:24:34 pyro_rp Frame-Count Audit:
   7.90 MB Raster, URAM Columns Bind, Right-Sizing Caps at
   ~25%](#11-aug-2026-112434) :complete:
- [EXPERIMENT 33: 11 Aug 2026 11:09:05 Why 5 MB from Two .v Files:
   Bitstream Size Is Region Raster, Not Logic](#11-aug-2026-110905)
   :complete:
- [EXPERIMENT 32: 11 Aug 2026 11:06:12 SNORT Program Source
   Walkthrough: Rules-to-Table Pipeline and the Program-Agnostic
   Engine](#11-aug-2026-110612) :complete:
- [EXPERIMENT 31: 11 Aug 2026 11:02:21 Minimum Static Analysis: Can
   All LUTs Be Dynamic? The ~5% Floor and Why](#11-aug-2026-110221)
   :complete:
- [EXPERIMENT 30: 11 Aug 2026 11:00:34 U250 LUT Census: 1.728M Total,
   Static vs Dynamic Under Both Shells](#11-aug-2026-110034)
   :complete:
- [EXPERIMENT 29: 11 Aug 2026 10:48:19 Literature Survey: No LLM.int8
   on FPGA — Adjacent Work and Why the Gap
   Exists](#11-aug-2026-104819) :complete:
- [EXPERIMENT 28: 11 Aug 2026 10:37:32 PR Delivery Paths on the U250:
   ICAP, MCAP, JTAG — What "Over PCIe" Actually
   Means](#11-aug-2026-103732) :complete:
- [EXPERIMENT 27: 11 Aug 2026 10:32:14 ICAP Load Estimate for pyro_rp:
   ~6 ms Projected vs 13.6-16.2 s JTAG Measured](#11-aug-2026-103214)
   :complete:
- [EXPERIMENT 26: 11 Aug 2026 10:28:45 Wire E2E Gains a Timing Report:
   Per-Packet Scan Latency, and a FAIL That Measured the RR
   Share](#11-aug-2026-102845) :complete:
- [EXPERIMENT 25:  7 Aug 2026 20:15:46 Broadcast Mode: Every Wire
   Frame to Both Programs, Coverage Without Partition](#7-aug-2026-201546)
   :complete:
- [EXPERIMENT 24:  6 Aug 2026 13:45:18 Overlay Scheduling: Co-Resident
   SNORT + MAC Programs, RR-Switched in Silicon](#6-aug-2026-134518)
   :complete:
- [EXPERIMENT 23:  6 Aug 2026 12:33:54 Precision Delta at Cap 16:
   the Prefix Cap Is Half of Everything the Trie Nominates](#6-aug-2026-123354)
   :complete:
- [EXPERIMENT 22:  6 Aug 2026 02:53:33 SR16 Oracle Over the Shared
   Trie: Zero Raw-Anchor Misses in 3,925 Cases](#6-aug-2026-025333)
   :complete:
- [EXPERIMENT 21:  6 Aug 2026 00:23:08 S4 ROM-Trie Child: URAM Has No
   Init, Boot Expansion, 21,332 States Baked](#6-aug-2026-002308)
   :complete:
- [EXPERIMENT 20:  5 Aug 2026 23:22:52 Per-Packet Wire Match Timing: Scan
   Core, Wrapper, Host RTT](#5-aug-2026-232252) :complete:
- [EXPERIMENT 19:  5 Aug 2026 22:52:33 Wire Traffic End-to-End: G4
   Flash, Loopback, 8.9M Frames](#5-aug-2026-225233) :complete:
- [EXPERIMENT 18:  5 Aug 2026 03:28:37 Wire-Scan Path: Raw Frames
   Through the Overlay Child](#5-aug-2026-032837) :complete:
- [EXPERIMENT 17:  4 Aug 2026 19:27:33 Quantify: FPGA vs.
   Userspace Snort](#4-aug-2026-192733) :complete:
- [EXPERIMENT 16: 20 Jul 2026 03:15:04 P2d Lands — 1.62 GiB/s Over QDMA Char-Devs, R1 Floor Crossed, AC-3-3 PASSES on Silicon](#20-jul-2026-031504) :complete:
- [EXPERIMENT 15: 19 Jul 2026 14:43:10 Jumbo Shell Boots From QSPI — 567 MiB/s Pipelined (4.7× over 1518), Two onic MTU Defects Patched](#19-jul-2026-144310) :complete:
- [EXPERIMENT 14: 16 Jul 2026 06:06:50 P2b Lands — 8 B/cyc Engine on Silicon at 1.97 GB/s On-Chip, Timing Closed at 251.9 MHz](#16-jul-2026-060650) :complete:
- [EXPERIMENT 13: 16 Jul 2026 04:48:44 R85a Recovery Folded into load_partial, Device-Gated ACs on Silicon, and the Pipelining Measurement That Reframed P2](#16-jul-2026-044844) :complete:
- [EXPERIMENT 12: 15 Jul 2026 14:23:02 JTAG Wedge Recovered In-Band — User+QDMA Soft-Reset Sequence, and the First R45a Counter Read on Silicon](#15-jul-2026-142302) :complete:
- [EXPERIMENT 11: 15 Jul 2026 03:44:16 Phase-3 Slate v2.5.0 + First Real HW Partial — R73a Gate Bug Caught by Its Own Safety Net, and JTAG PR Wedges the RP](#15-jul-2026-034416) :complete:
- [EXPERIMENT 10: 14 Jul 2026 20:26:10 Counter Wedge Fixed — a Circular-Import Corpse, and Why the Workaround Failed](#14-jul-2026-202610) :complete:
- [EXPERIMENT 9: 14 Jul 2026 18:35:59 AC-3-1 + AC-3-4 Land — Sabotage-Verified Suites, and a Counter-Wedge Bug Found](#14-jul-2026-183559) :complete:
- [EXPERIMENT 8: 14 Jul 2026 16:23:15 Native Routing Hot Path (R3c) — R3b Reachable at ~1.09×, Warmup Defect Found in the Recipe](#14-jul-2026-162315) :complete:
- [EXPERIMENT 7: 14 Jul 2026 08:49:52 PR Shell Rebuilt From Source on nf-server06 — New Card, New Flash, device_usable=true](#14-jul-2026-084952) :complete:
- [EXPERIMENT 6:  9 Jul 2026 10:59:06 U250 QSPI Flash — PYRO PR Shell User Image](#9-jul-2026-105906) :complete:
- [EXPERIMENT 5:  6 Jul 2026 14:05:00 PYRO Phase 2b — PR Shell + First pr_bitstream Partial](#6-jul-2026-140500) :complete:
- [EXPERIMENT 4:  6 Jul 2026 02:50:21 PYRO Phase 2 — Real Vivado Flow, Estimator Calibration](#6-jul-2026-025021) :complete:
- [EXPERIMENT 3:  5 Jul 2026 12:05:02 PYRO Phase 1 — Per-Pattern Circuits, Synthesis Service, C ABI](#5-jul-2026-120502) :complete:
- [EXPERIMENT 2:  5 Jul 2026 02:44:00 PYRO Phase 0 — Software Shim, Classifier, Model](#5-jul-2026-024400) :complete:
- [EXPERIMENT 1:  4 Jul 2026 07:33:45 FPGA Platform Discovery](#4-jul-2026-073345) :complete:
---
...
# EXPERIMENT  6 Jul 2026 02:50:21 PYRO Phase 2 — Real Vivado Flow,
Estimator Calibration :complete:
...
# EXPERIMENT  5 Aug 2026 22:52:33 Wire Traffic End-to-End: G4 Flash,
Loopback, 8.9M Frames :complete:

## 1. Hypothesis

With the wiretap shell flashed (G4, owner-authorized) and CMAC
near-end loopback enabled, does live wire traffic flow through the
complete OQ-2 path — TX generator -> loopback -> adapter -> arbiter
-> `pyro_rp` wire-scan -> overlay engine -> wire MATCH_REPLY -> C2H
-> host — with the R78.13 drop/scan/nominate semantics and SR14'
epoch attribution intact at rate?

## 2. How

- **Equipment:** nf-server06, U250 at 0000:02:00.0, QSPI-flashed
  with the OQ-2 wiretap static (build_timestamp 0x08042258); no
  transceiver — CMAC-0 near-end PMA loopback.
- **Software:** `overlay_wire.bit` (wire-scan wrapper + 40,960-state
  overlay engine, linked vs the wiretap static at WNS +0.020,
  pr_verify OK); onic netdev; `pyro.device` R78 host stack.
- **Benchmarks:** `scripts/pyro_wire_e2e.py` three-phase experiment;
  TX generator emits one 64 B frame / 1024 cycles (~245k frames/s).

### Key commands

```bash
sudo rmmod onic                       # driver off a soon-dead card
PYRO_FLASH_ALLOW_LIVE_PCIE=1 scripts/flash_u250.sh flash \
    hw/dfx/build-wiretap/dcp/open_nic_shell.bit       # 16m24s
...
# cold power cycle, then:
sudo scripts/pyro_wedge_recover.sh
PYRO_DEVICE_IFACE=ens2 .venv-pyro/bin/python3 scripts/pyro_hw.py \
    load hw/dfx/build-wiretap/partials/overlay_wire.bit
PYRO_DEVICE_IFACE=ens2 .venv-pyro/bin/python3 \
    scripts/pyro_wire_e2e.py
```

## 3. Observations

Flash erase/program/verify clean; host uptime unbroken (onic was
unloaded first — the 14 Jul live flash was benign only because the
card sat on golden).  Cold boot: `10ee:903f`, wiretap
build_timestamp, loopback aligned (`RX_STATUS` 0xc0 -> 0x3).

| Phase (3 s window)   | seen    | scanned | drops   | noms    |
|----------------------|---------|---------|---------|---------|
| A: no table          | 734,648 | 0       | 734,648 | 0       |
| B: clean table       | 734,409 | 734,409 | 0       | 0       |
| C: matching table    | 733,918 | 733,918 | 0       | 733,918 |

- B captured **0** wire MATCH_REPLYs; C captured 50/50 valid:
  slot=1, **epoch=2**, pid=0, end=14, header flags=0.
- Cumulative after the run: **seen 8,857,765 = scanned 8,104,168 +
  drops 753,597** — zero slack over 8.9M frames.
- A table swap (epoch 2 -> 3) succeeded WHILE wire frames arrived
  at full rate.

## 4. Data analysis

Every R78.13 property verified in xsim this morning holds on
silicon at ~245k frames/s: fail-closed counted drops without a
table, reply-only-on-nomination (silence is accounted for, not
assumed), and per-reply epoch attribution on live wire traffic.
The 64 B x 245k/s load is 15.7 MB/s — comfortably inside the
32-50 MB/s single-engine rate, which is why scanned == seen with
zero drops in phases B/C; line rate remains a banking problem, as
priced in the spike design.  The concurrent table swap shows the
packet-atomic arbiter doing its one job: host control frames
interleave with wire traffic, neither starving.  The wire counters'
exact reconciliation over 8.9M frames is the strongest available
evidence that no frame takes an unaccounted path.

## 5. Ideas for future experiments

- Sweep GAP_CYCLES down (denser wire load) to find where the
  adapter RX FIFO's honest drop counters first move — the measured
  headroom curve for a single engine.
- Bank N engines behind a spreader to close the 15.7 MB/s ->
  12.5 GB/s gap; the wire path is now measurable per-engine.
- Snort-rule table (S2 group emitter) + crafted loopback corpus:
  end-to-end sid attribution from wire traffic to daemon.
- Real traffic ingest: QSFP DAC to a peer NIC instead of loopback
  (needs a cable and a link partner; everything else is now known
  to work).
...
# EXPERIMENT 6 Aug 2026 12:33:54 Precision Delta at Cap 16: the
Prefix Cap Is Half of Everything the Trie Nominates :complete:

## 1. Hypothesis

The S4 trie's over-nomination against the AC-S3-2 lowered chains
is measurable and decomposable into its three causes — the 16-byte
prefix cap (`anchor_cap`), fold-all (`case_fold`), and anchor-only
matching vs chains (the price A5 already paid) — with the
soundness chain `trie ⊇ uncapped ⊇ anchor ⊇ lowered` holding on
every subject: the cap and fold only ever ADD host re-verification
work, never lose a detection.

## 2. How

`pyro.snort.shared_trie` grew the per-group `precision_delta`
generalized to gid:sid space: `precision_prepare` compiles per-rule
matchers once (306 chain-bearing lowerings get real regexes; the
3,590 anchor-escape entries reuse the anchor occurrence test), and
`precision_tiers` computes four nomination sets per subject —
S4 trie scan, uncapped folded anchors, A5 anchor tier (fold iff
nocase), lowered chains.  Measured over the SR16 corpus' 2,436
unique streams (1,519 sweep plain + 898 R15-permuted + 19
designed; `_seg` variants are byte-identical streams, excluded).
Falsifiability: three subjects built to sit exactly on each tier
boundary (a bare 16-byte prefix of a longer anchor; a folded
case-sensitive anchor; an anchor whose chain needs more than the
anchor) must separate the tiers strictly.  Pinned in
`test_acs4_sr16_oracle.py`; runs in ~5 s, no device, no Snort.

## 3. Observations

- Soundness held on all 2,436 streams; all three boundary subjects
  separate their tiers strictly.
- Totals (nomination events, pinned): trie 52,249 → uncapped
  26,004 → anchor 20,108 → lowered 14,187.
- Decomposition of the trie's 52,249: **extra_cap 26,245 (50.2%)**,
  extra_fold 5,896 (11.3%), extra_chain 5,921 (11.3%), surviving
  the lowered chains 14,187 (27.2%).  Over-nomination factor vs
  lowered: 3.68x.
- By sub-corpus, per case: sweep plain trie 20.1 vs lowered 5.4
  (cap 8.7, fold 2.3, chain 3.8); R15-permuted trie 23.3 vs 6.2
  (cap 14.5 — permutation defeats exact-case tiers, the folded
  prefix still fires); designed HTTP trie 37.8 vs 24.4 (cap only
  4.5 — realistic requests hit real anchors, families matter less).

## 4. Data analysis

The number SF14's cap-16 decision owes is now on the table: the
cap, not the fold, is the dominant precision cost — half of every
nomination the trie makes exists only because 16-byte prefixes
collapse rule families.  This matches Gate 2's FP shape
(anchor_cap 38,205, its largest class) from the independent
Snort-arbitrated direction.  The fold's price is a modest 11% —
the single-engine design bought its one-compare fabric cheaply.
Notably the chain delta (11%) bounds what a chain-bearing ROM trie
could recover; the cap delta is 4.4x that, so if precision ever
matters at the suppression tier, revisiting the cap (cap-24, or
capping only non-family anchors) beats adding chains to the child.
All of it stays SR5-absorbed re-verification work: `sound` was
true on every stream, so nothing here touches completeness.

## 5. Ideas for future experiments

- Price cap-24/cap-32 the same way: states vs extra_cap curve, one
  build each (the estimator already prices the URAM/BRAM side).
- Weight the tiers by wire frequency (replay a real capture, not
  anchor-bearing corpora) to get an operational, not adversarial,
  over-nomination rate.
...
# EXPERIMENT 11 Aug 2026 10:37:32 PR Delivery Paths on the U250:
ICAP, MCAP, JTAG — What "Over PCIe" Actually Means :complete:

## 1. Hypothesis

Can the dynamic region be reprogrammed over the PCIe bus, or only
through the ICAP? Companion analysis to the 10:32:14 ICAP estimate:
enumerate every configuration-frame entry point on this die and
what each would cost. No new silicon data.

## 2. How

- **Equipment:** none exercised; UltraScale+ XCU250 architecture
  facts plus prior measurements on this card and the Coyote driver
  sources (`driver/include/reconfig/reconfig_mem.h`: bitstreams
  "need to be written to the ICAP from the driver via PCIe and the
  XDMA core").
- **Software:** analysis only.
- **Benchmarks (inputs):** JTAG PR measured here (13.6-16.2 s);
  Coyote ICAP calibration (55.8 MB in 49 ms); MCAP frame delivery
  via PCIe extended-config-space writes (single-digit MB/s class).

### Key commands

```bash
# none — architecture analysis; sources cited inline
```

## 3. Observations

Configuration frames can only enter the fabric through a
configuration port; "PR over PCIe" always means PCIe delivery PLUS
one of these ports:

| Port        | Needs in static    | Rate          | 5.6 MB rp | 55.8 MB shell |
|-------------|--------------------|---------------|-----------|---------------|
| ICAP        | ICAPE3 + ctrl      | ~0.8-1.1 GB/s | ~6 ms     | ~50 ms [m]    |
| MCAP (VSEC) | PCIe IP option     | ~MB/s class   | ~1-2 s    | ~10-20 s      |
| JTAG        | none (cable)       | ~0.35 MB/s    | 13.6-16.2 s [m] | minutes |

[m] = measured (Coyote docs / this card); others projected.

Breakdown of the Coyote 49 ms (driver source, `reconfig_hw.c`):
the driver does not copy the bitstream itself — it queues hugepage
descriptors (addr + len) to a config engine in the static region,
which fetches pages from host memory over XDMA and streams them
into the ICAP, with RECONFIG_THRESHOLD commands in flight. Data
transfer and configuration therefore OVERLAP; the 49 ms is the
pipeline drained at its slowest stage, the ICAP (~1.1 GB/s
effective). Standalone PCIe delivery of 55.8 MB would be ~4.5-5 ms
(~10% bus duty during the load) — the transfer is fully hidden
under the ICAP write.

On this card today:

- **Coyote shell**: PCIe DMA -> ICAP path exists (XDMA + ICAPE3 in
...
The question "PCIe or ICAP?" is a false dichotomy: PCIe is the
delivery channel, the port is the funnel, and the funnel sets the
rate. ICAP is the only port in the same decade as the bus (and
still ~10x slower than PCIe delivery); MCAP exists precisely so a
host can do PR with zero fabric support, but frame-by-config-write
delivery caps it at JTAG-class times without the cable — useful
for recovery, useless for scheduling. For a future wiretap static
rebuild the ordering is therefore unambiguous: wire an ICAP
(millisecond exec tier, the 10:32:14 projection) rather than
enable MCAP (second-class exec, no ladder movement). Enabling both
costs little and MCAP would serve as a cable-free recovery path
for a wedged RP — today's `pyro_wedge_recover.sh` still assumes
JTAG.
...
- Measure MCAP throughput on any MCAP-enabled shell to replace
  the "single-digit MB/s class" estimate with a number.
- Coyote example 05 run to convert the 49 ms shell-ICAP figure
  from documentation to a local measurement.


---

# EXPERIMENT 11 Aug 2026 10:48:19 Literature Survey: No LLM.int8
on FPGA — Adjacent Work and Why the Gap Exists :complete:

## 1. Hypothesis

Does a faithful FPGA implementation of LLM.int8() (Dettmers et
al., NeurIPS 2022 — runtime outlier-column decomposition into a
small fp16 GEMM beside a large int8 GEMM) exist in the published
literature? Web survey, 11 Aug 2026; no silicon work.

## 2. How

- **Equipment:** none — literature search.
- **Software:** web search over arXiv, ACM DL, vendor blogs.
- **Benchmarks:** n/a.

### Key commands

```bash
# searches: "LLM.int8 FPGA implementation outlier decomposition",
# "FPGA LLM inference accelerator int8 outlier-aware quantization"
```

## 3. Observations

- **No faithful port found.** LLM.int8() lives in `bitsandbytes`,
  bound to GPU int8 tensor cores via cuBLASLt; its defining
  mechanism — runtime detection of outlier feature columns (~0.1%
  of dimensions, threshold alpha = 6.0) splitting each GEMM into
  fp16 (outliers) + int8 (the rest) — has no published FPGA
  implementation.
- **Adjacent FPGA work:**
  - *TATAA* (ACM TRETS 2025): transformable DSP datapath, int8
    linear layers + bfloat16 non-linear ops — mixed precision
    partitioned by layer type, not by outlier column.
  - *LNS-LLM*: handles activation outliers on an Alveo U280 via
    logarithmic number system arithmetic, not decomposition.
  - *FPGA spatial-acceleration study* (ACM TRETS 2024) and U280
    successors: Llama-class int8/W4A8 at ~213-290 tokens/s
    (Llama2-7B, ~46 W) — outliers handled OFFLINE
    (SmoothQuant-style migration into weights, GPTQ-family
    weight quantization) so the datapath stays uniform.

## 4. Data analysis

The gap is architectural, not an oversight. LLM.int8()'s dynamic
decomposition suits GPUs: fp16 and int8 units coexist idle-or-not,
and the memory system tolerates gathering scattered outlier
columns. On an FPGA the same structure costs a duplicated fp16
datapath plus gather/scatter irregularity in exactly the places
fabric designs win by being regular — so the FPGA literature
reaches LLM.int8-class accuracy by moving the outlier problem to
quantization time instead of the datapath. A novel implementation
would therefore be publishable: the int8 GEMM fabric is
well-trodden; the runtime outlier-column detector + dual-precision
decomposed GEMM is the unclaimed part. On a U250 specifically,
DSP48E2s do int8 natively while fp16 is area-expensive, arguing
for a few shared FP units (or an int16 outlier path) rather than
replicating the GPU's structure.

Sources: arXiv:2208.07339 (LLM.int8), ACM 10.1145/3714416
(TATAA), ACM 10.1145/3656177 (spatial acceleration), arXiv:
2410.04466 (hardware survey), HF blog hf-bitsandbytes-integration.

## 5. Ideas for future experiments

- If ever relevant to this project: prototype the outlier-column
  detector as a streaming reduction (per-column max vs alpha) —
  it is structurally close to the A5 scan pipeline's per-byte
  reductions and would reuse the same AXIS discipline.
- Estimate U250 resources for a 99.9%-int8 / 0.1%-fp16 decomposed
  GEMM at Llama-7B dimensions; compare against the W4A8 uniform
  baselines from the TRETS study.
- Track whether bitsandbytes' multi-backend work ever grows a
  non-GPU target worth cribbing interfaces from.


---

# EXPERIMENT 11 Aug 2026 11:00:34 U250 LUT Census: 1.728M Total,
Static vs Dynamic Under Both Shells :complete:

## 1. Hypothesis

How many LUTs does this card have, and how do they split between
static and dynamic regions? The answer depends on which shell
defines the PR boundary — tabulate both. Report reading + floorplan
arithmetic; no new synthesis.

## 2. How

- **Equipment:** U250 (XCU250, VU13P-class die: 4 SLRs x 432k LUT,
  8x16 clock-region grid).
- **Software:** Vivado 2025.2 utilization report from the Coyote
  hello-world shell build (7 Aug,
  `examples/01_hello_world/hw/build_hw/reports/
  shell_utilization.rpt`) and the Coyote U250 static floorplan
  (`hw/constraints/u250/fplan/u250_static_floorplan.xdc`); PYRO
  RP budget from the 6 Aug overlay-scheduling entry.
- **Benchmarks:** n/a — census.

### Key commands

```bash
grep -A6 '^| CLB LUTs' \
    .../build_hw/reports/shell_utilization.rpt
```

## 3. Observations

Die totals (Vivado report, authoritative): **1,728,000 CLB LUTs**
(791,040 LUTRAM-capable), 3,456,000 FFs.

Coyote shell (measured from our build):

| Partition            | LUTs           | Share  |
|----------------------|----------------|--------|
| Static layer (fixed) | 80,009 used    | 4.6%   |
| Dynamic (shell) region | ~1.4M capacity [e] | ~80% |
| - hello-world shell uses | 109,382    | 6.3%   |

[e] estimate: the shell pblock spans 104/128 clock regions plus
slice ranges; per-region LUT counts vary by column type.

Wiretap/OpenNIC shell (resident):

| Partition            | LUTs           | Share  |
|----------------------|----------------|--------|
| Dynamic (`pyro_rp`)  | 80,000 budget  | 4.6%   |
| - SNORT+MAC child uses | 21,034       | 1.2%   |
| Static (all else)    | ~1.65M         | 95.4%  |

## 4. Data analysis

The two shells are near-mirror images around the same number:
Coyote's static layer (80,009 LUTs used) and PYRO's dynamic
region (80,000 LUT budget) are each ~1/21 of the die, with
opposite roles — Coyote locks that much and makes ~80% of the
card runtime-reprogrammable; the wiretap shell frees exactly that
much and freezes the rest (including all unused fabric). The
remaining ~15% under Coyote sits outside both pblocks (I/O, GT,
config columns). Consequence for this project: everything PYRO
schedules must fit the 80k pocket (SNORT+MAC uses 26% of it),
while a Coyote-hosted future would invert the constraint — the
80k limit would become a ~1.4M limit at the price of adopting
Coyote's shell as the resident static.

## 5. Ideas for future experiments

- Exact dynamic-region LUT capacity under Coyote: open the routed
  DCP and sum per-clock-region LUT counts inside the shell pblock
  (replaces the ~1.4M estimate).
- Same census for BRAM/URAM/DSP across both shells — the memory
  split matters more than LUTs for A5-style engines.
- If an N=16 engine ladder ever lands: 80k-pocket fit study vs a
  Coyote-hosted vFPGA port.


---

# EXPERIMENT 11 Aug 2026 11:02:21 Minimum Static Analysis: Can
All LUTs Be Dynamic? The ~5% Floor and Why :complete:

## 1. Hypothesis

Companion to the 11:00:34 LUT census: could a shell make 100% of
the card's 1.728M LUTs dynamic, and if not, what is the minimum
static footprint? Architecture analysis; no new synthesis.

## 2. How

- **Equipment:** U250 facts from prior entries (LUT census,
  PR-delivery-paths, MCAP-absence lspci check); Coyote static
  utilization from our 7 Aug build report.
- **Software:** analysis only; UltraScale+ DFX rules.
- **Benchmarks:** n/a.

### Key commands

```bash
# none — architecture analysis
```

## 3. Observations

UltraScale+ DFX permits reconfigurable partitions containing
nearly everything (logic, BRAM/URAM, IOBs, GTs), so a ~100%
pblock is drawable. Three structural costs arrive at that limit:

1. **Frame delivery**: a fabric ICAP controller cannot sit inside
   the region it rewrites (it would reprogram itself mid-stream);
   an all-dynamic device falls back to hard-silicon paths only —
   JTAG (13.6-16.2 s measured here) or MCAP (MB/s-class;
   confirmed absent on the resident shell).
2. **The PCIe endpoint dies**: XDMA/QDMA fabric logic inside the
   rewritten region drops the link mid-load — surprise link-down,
   host rescan, wedged drivers. Keeping the endpoint alive during
   reconfiguration is the static layer's entire purpose (it is
   why Coyote swaps 53 MiB of shell in 49 ms with the device
   never leaving the bus).
3. **Anchoring**: partition pins and the clock sources feeding
   the boundary need static context; a 100% pblock leaves none.

## 4. Data analysis

"All LUTs dynamic" therefore collapses into "full reprogramming
with the device off the bus" — exactly the cyt_top.bit cold-start
flow (JTAG, seconds dark, PCIe rescan), i.e. not partial
reconfiguration at all. For a card that stays enumerated, the
minimum static is the PCIe endpoint + configuration path + PR
plumbing, and Coyote's measured static layer is close to that
floor: **80,009 LUTs = 4.6%** of the die, bounding the dynamic
ceiling near **~95% architecturally**, of which Coyote's actual
floorplan claims ~80% (the gap is placement margin plus I/O, GT
and config columns that make poor pblock territory). The design
space is then a one-axis dial: the wiretap shell sits at one end
(4.6% dynamic, everything else frozen), Coyote near the other
(~80% dynamic above a ~5% static floor); no shell on a
PCIe-attached card can reach 100%.

## 5. Ideas for future experiments

- Price a "minimal Coyote": static layer stripped to XDMA + ICAP
  path alone (no PR-region niceties) — how far under 80k LUTs
  can the floor go on this die?
- Two-tier DFX (nested): a small static + a big outer RP that
  itself hosts pyro_rp-style inner RPs — Coyote's UltraScale+
...
# EXPERIMENT 11 Aug 2026 11:09:05 Why 5 MB from Two .v Files:
Bitstream Size Is Region Raster, Not Logic :complete:

## 1. Hypothesis

The SNORT engine is ~2 main .v files (~800 lines) yet its partial
is 5.4 MB — is image size a function of the logic or of the
region? Explain from artifacts already built; no new synthesis.

## 2. How

- **Equipment:** none — built partials in
  `hw/dfx/build-wiretap/partials/` and prior entries' numbers.
- **Software:** analysis of PR bitstream structure.
- **Benchmarks:** n/a.

### Key commands

```bash
ls -la hw/dfx/build-wiretap/partials/*.bit
```

## 3. Observations

A PR bitstream carries every configuration frame of its pblock —
LUT truth tables, routing switchboxes, BRAM contents — used or
not. The built partials isolate the two variables:

| Partial          | Logic inside          | Image    |
|------------------|-----------------------|----------|
| id_stub          | near-empty stub       | 3.39 MB  |
| overlay_wire     | SNORT, 13.1k LUT      | 5.40 MB  |
| multi_mac_wire   | SNORT+MAC, 21.0k LUT  | 5.64 MB  |

- Region floor: an almost-empty `pyro_rp` still costs **3.39 MB**
  (frame count of the pblock; empty frames compress well).
- Marginal logic cost: +13.1k LUT + 111.5 BRAM + 50 URAM = +2.0 MB
  of reduced compressibility; the next +8.0k LUT = **+0.24 MB**.
- Same law one level up: Coyote's 55.8 MB shell partial covers
  ~80% of the die; ours covers 4.6%.

## 4. Data analysis

Bitstream size is a raster of the region's silicon, not an object
file of the logic: the .v files are the program text, the partial
is a core dump of the entire address space — the region's full
configuration state, occupied or not. Content only modulates
compressibility (3.39 -> 5.40 -> 5.64 MB across a 0 -> 13k -> 21k
LUT sweep). Consequences: (1) every partial for a region is
roughly the same size, which is why the ICAP-estimate entry could
treat "the pyro_rp image" as a single ~5.6 MB quantity; (2) the
only real lever on image size — and hence on any load time, JTAG
or future ICAP — is the pblock extent, making the frame-count
audit (shrink the floorplan to fit the 21k-LUT reality instead of
the 80k budget) worth ~60% off every future load.

## 5. Ideas for future experiments

- Frame-count audit (carried from the ICAP entry): price a
  pyro_rp pblock sized to ~30k LUT — projected image ~2 MB and
  JTAG loads down ~2.5x with zero RTL change.
- Compression sweep: same child built with/without bitstream
  compression to separate frame count from compressibility.
